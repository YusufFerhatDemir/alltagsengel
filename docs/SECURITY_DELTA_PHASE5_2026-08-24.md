...
| ~~**P2-c**~~ | ~~7 Tabellen ohne org_fence~~ **TEILWEISE GEFIXT** via `apply_migration` (20261003000003). 5 von 7 Tabellen haben jetzt RESTRICTIVE org_fence: `billing_tarif_belege`, `billing_tariff_audit`, `organization_subscriptions`, `state_settings`, `state_settings_audit`. **Bewusst ausgelassen:** `organization_members` (Multi-Org-Verwaltung), `state_waitlist` (öffentliche Warteliste). Live verifiziert. | `pg_policies` | ✅ 5/7 erledigt 2026-08-24, 2/7 bewusst offen |
