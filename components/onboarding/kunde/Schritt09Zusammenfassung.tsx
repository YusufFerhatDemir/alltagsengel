'use client'
/** Schritt 9 — Angaben prüfen, je Block ein Korrektur-Knopf. */
...
export default function Schritt09Zusammenfassung({ alleDaten, geheZuSchritt, disabled }: WizardMaskeProps) {
    ...
    <div style={{ display: 'grid', gap: 12 }}>
      {offen.length > 0 && (
        <p role="status" style={{
          ...
          Es fehlen noch: {offen.join(', ')}. Sie können die Anfrage trotzdem
          senden — wir fragen die Angaben dann nach.
        </p>
      )}
