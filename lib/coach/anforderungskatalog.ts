...
export const ANFORDERUNGSKATALOG: KatalogEintrag[] = [
  ...
  },
  {
    ...
    quelle: 'DiPAV §7 ("Als interoperable Formate... gelten offene, international anerkannte Standards und vom Hersteller... bereitgestellte Profile über offene, international anerkannte Standards"), §2 Abs. 1 Nr. 20, Fassung 22.06.2026 — DiPAV schreibt KEIN bestimmtes Format (z. B. FHIR) verbindlich vor; Verbindlichkeit eines konkreten Formats bleibt offene Frage ORF-9 / BfArM-Frage 10, dafür weiterhin BfArM-Leitfaden nötig. Intern geprüft 14.08.2026: Arbeitsfassung passt zur Grundanforderung "offene Standards", nicht zu einer FHIR-Pflicht.',
    anforderungstextGeprueft: true, stand: 'in_arbeit',
  ...
  },
  {
    ...
    quelle: 'DiPAV §3 Abs. 3 Satz 2 nennt "eine Risikoanalyse und -bewertung in erwarteter Nutzung" als Beispiel für geeignete Nachweise, die das BfArM aus begründetem Anlass verlangen kann, Fassung 22.06.2026; zusätzlich audit/dipa/risikoanalyse_pflegecoach.md, risikoakte_pflegecoach.md. Hinweis: DiPAV formuliert dies als Beispiel-Nachweis, nicht als eigenständige Pflichtanforderung; BfArM-Leitfaden-Konkretisierung steht noch aus. Intern geprüft 14.08.2026.',
    anforderungstextGeprueft: true, stand: 'erfuellt',
