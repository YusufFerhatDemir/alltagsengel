// ═══════════════════════════════════════════════════════════
// EINZUGSGEBIET: GEMEINSAME PLZ-LOGIK (Kern-/Randgebiet)
// ═══════════════════════════════════════════════════════════
// Eine Quelle der Wahrheit für den PLZ-Check auf der Homepage
// (components/EinzugsgebietKarte.tsx) und /einzugsgebiet
// (components/EinzugsgebietLeaflet.tsx) — gleiche PLZ,
// gleiche Antwort auf beiden Seiten.
// ═══════════════════════════════════════════════════════════
...
/**
 * Prüft eine 5-stellige PLZ gegen Kern- und Randgebiet.
 * Längste Präfixe gewinnen (spezifischste Region zuerst).
 */
