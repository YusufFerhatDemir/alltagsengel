...
const BESTAND: { datei: string; tabelle: string; operation: string }[] = [
  ...
  { datei: 'app/admin/verordnungen/actions.ts', tabelle: 'assignments', operation: 'delete' },
  { datei: 'app/admin/verordnungen/actions.ts', tabelle: 'einsatz_absagen', operation: 'delete' },
  { datei: 'app/admin/verordnungen/actions.ts', tabelle: 'einsatz_absagen', operation: 'update' },
  { datei: 'app/admin/verordnungen/actions.ts', tabelle: 'invoices', operation: 'update' },
  ...
  { datei: 'app/admin/zahlungskontrolle/actions.ts', tabelle: 'payment_status', operation: 'update' },
  ...
  { datei: 'app/engel/verfuegbarkeit/actions.ts', tabelle: 'angel_availability', operation: 'delete' },
  ...
  { datei: 'app/mis/complaints/actions.ts', tabelle: 'mis_complaints', operation: 'delete' },
  { datei: 'app/mis/complaints/actions.ts', tabelle: 'mis_complaints', operation: 'update' },
  { datei: 'app/mis/contracts/actions.ts', tabelle: 'mis_contracts', operation: 'delete' },
  ...
  { datei: 'app/mis/privacy/actions.ts', tabelle: 'mis_privacy_records', operation: 'delete' },
  { datei: 'app/mis/privacy/actions.ts', tabelle: 'mis_privacy_requests', operation: 'update' },
  { datei: 'app/mis/recruiting/actions.ts', tabelle: 'mis_applicants', operation: 'delete' },
  { datei: 'app/mis/recruiting/actions.ts', tabelle: 'mis_applicants', operation: 'update' },
  { datei: 'app/mis/recruiting/actions.ts', tabelle: 'mis_job_postings', operation: 'delete' },
  { datei: 'app/mis/recruiting/actions.ts', tabelle: 'mis_job_postings', operation: 'update' },
  { datei: 'app/mis/scheduling/actions.ts', tabelle: 'mis_availability', operation: 'delete' },
  { datei: 'app/mis/scheduling/actions.ts', tabelle: 'mis_shifts', operation: 'delete' },
  { datei: 'app/mis/scheduling/actions.ts', tabelle: 'mis_shifts', operation: 'update' },
  { datei: 'app/mis/signatures/actions.ts', tabelle: 'mis_signature_requests', operation: 'delete' },
  ...
  { datei: 'app/mis/training/actions.ts', tabelle: 'mis_training_catalog', operation: 'delete' },
  { datei: 'app/mis/training/actions.ts', tabelle: 'mis_training_records', operation: 'delete' },
  { datei: 'app/mis/training/actions.ts', tabelle: 'mis_training_records', operation: 'update' },
  { datei: 'app/mis/vehicles/actions.ts', tabelle: 'mis_vehicles', operation: 'delete' },
