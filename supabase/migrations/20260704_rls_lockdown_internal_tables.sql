...
DROP POLICY IF EXISTS "budget_tx_admin_all" ON public.budget_transactions;
...
DROP POLICY IF EXISTS "cg_bonuses_admin_all" ON public.caregiver_bonuses;
...
DROP POLICY IF EXISTS "cg_docs_admin_all" ON public.caregiver_documents;
...
DROP POLICY IF EXISTS "cg_initials_admin_all" ON public.caregiver_initials_history;
...
DROP POLICY IF EXISTS "caregiver_quals_admin_all" ON public.caregiver_qualifications;
...
DROP POLICY IF EXISTS "client_budgets_admin_all" ON public.client_budgets;
...
DROP POLICY IF EXISTS "preferred_subs_admin_all" ON public.client_preferred_substitutes;
...
DROP POLICY IF EXISTS "coop_partners_admin_all" ON public.cooperation_partners;
...
DROP POLICY IF EXISTS "invoice_disputes_admin_all" ON public.invoice_disputes;
...
DROP POLICY IF EXISTS "partner_visits_admin_all" ON public.partner_visits;
...
DROP POLICY IF EXISTS "satisfaction_calls_admin_all" ON public.satisfaction_calls;
...
DROP POLICY IF EXISTS "sub_requests_admin_all" ON public.substitution_requests;
...
DROP POLICY IF EXISTS "mis_ai_conversations_admin_select" ON public.mis_ai_conversations;
...
DROP POLICY IF EXISTS "mis_budget_items_admin_select" ON public.mis_budget_items;
...
DROP POLICY IF EXISTS "mis_capa_admin_select" ON public.mis_capa;
...
DROP POLICY IF EXISTS "mis_dataroom_access_admin_select" ON public.mis_dataroom_access;
...
DROP POLICY IF EXISTS "mis_dataroom_sections_admin_select" ON public.mis_dataroom_sections;
...
DROP POLICY IF EXISTS "mis_document_categories_admin_select" ON public.mis_document_categories;
...
DROP POLICY IF EXISTS "mis_document_versions_admin_select" ON public.mis_document_versions;
...
DROP POLICY IF EXISTS "mis_financial_reports_admin_select" ON public.mis_financial_reports;
...
DROP POLICY IF EXISTS "mis_purchase_orders_admin_select" ON public.mis_purchase_orders;
...
DROP POLICY IF EXISTS "mis_quality_audits_admin_select" ON public.mis_quality_audits;
...
DROP POLICY IF EXISTS "mis_quality_processes_admin_select" ON public.mis_quality_processes;
...
DROP POLICY IF EXISTS "mis_suppliers_admin_select" ON public.mis_suppliers;
...
DROP POLICY IF EXISTS "mis_tasks_admin_select" ON public.mis_tasks;
