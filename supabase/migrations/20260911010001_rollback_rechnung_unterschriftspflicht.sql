-- ═══════════════════════════════════════════════════════════════════════════
-- ROLLBACK zu 20260911010000_rechnung_unterschriftspflicht.sql
-- ═══════════════════════════════════════════════════════════════════════════
--
-- Stellt create_invoice_draft_atomic v7 (20260908000000) wieder her — also
-- den Stand OHNE Unterschriftspruefung.
--
-- WARNUNG: Nach dem Rollback koennen Leistungsnachweise ohne jeden
-- Unterschriftsnachweis (proof_status='ENTWURF', signature_hash IS NULL)
-- wieder fakturiert werden. Das ist die Luecke H-1. Nur einspielen, wenn die
-- Unterschriftspflicht den Betrieb nachweislich blockiert und die Nachweise
-- nicht kurzfristig nachsigniert werden koennen.
-- ═══════════════════════════════════════════════════════════════════════════
