-- Rollback fuer 20260831050000_fail_closed_tarif_status_rpcs.sql
-- Stellt die Fassungen aus 20260808120002 (create_invoice_draft_atomic, v5)
-- und 20260808120000 (zaehle_kassentarife) wieder her — ohne tarif_status-Filter.
-- ACHTUNG: reisst die Fail-Closed-Absicherung wieder auf. Nur fuer Notfaelle.
