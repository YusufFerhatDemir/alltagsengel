...
const cities: Record<string, CityData> = {
  ...
  maintal: {
    ...
    lokal: 'In Maintal sind unsere Alltagsbegleiter in allen vier Stadtteilen unterwegs — von Dörnigheim am Main bis hinauf nach Wachenbuchen.',
  ...
  'bad-vilbel': {
    ...
    lokal: 'In Bad Vilbel begleiten wir Sie von der Kernstadt an der Nidda über Dortelweil und den Heilsberg bis nach Massenheim.',
  ...
  'main-taunus': {
    ...
    lokal: 'Im Main-Taunus-Kreis sind wir von Eschborn und Schwalbach im Osten über Hofheim und Kelkheim bis nach Hattersheim und Flörsheim im Westen unterwegs.',
