'use client'
// ═══════════════════════════════════════════════════════════════
// KIM / TI-Anbindung (Block 18) — Postfach- & Kartenverwaltung
//
// Verwaltungsoberfläche für Postfach-Konfiguration, Kartenzuordnung
// (eHBA/SMC-B) und die TA5-Formatversionen (spec_bestaetigt-Gate).
//
// Ursprünglich unter /admin/kim, umgezogen nach /admin/kim/postfach als
// die Fachlogik + UI für den eigentlichen Nachrichtenbetrieb (Provider-
// Abstraktion, Ein-/Postausgang, Adressbuch) unter /admin/kim gebaut wurde
// (WS3). Diese Seite bleibt bestehen: kim_konfiguration/kim_karten/
// kim_formatversionen sind weiterhin die Quelle für das TA5-Fail-Closed-Gate
// (s. lib/kim/provider-factory.ts).
//
// WICHTIG: Der Versand über DIESE Seite (kim_nachrichten, /api/billing/kim/*)
// ist bewusst weiterhin GESPERRT — kein Konnektor, keine Spezifikation.
// ═══════════════════════════════════════════════════════════════
