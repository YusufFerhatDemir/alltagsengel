        ...
        <div style={{ marginTop: 16, borderTop: '1px solid rgba(201,150,60,0.08)', paddingTop: 14 }}>
          ...
          <div style={{ display: 'flex', gap: 8 }}>
            ...
            <Link href="/investor" style={{ flex: 1, textDecoration: 'none' }}>
              <div style={{ textAlign: 'center', fontSize: 12, padding: '10px 0', background: 'rgba(201,150,60,0.06)', color: 'rgba(255,255,255,0.4)', border: '1px solid rgba(201,150,60,0.12)', borderRadius: 10 }}>Investor Portal</div>
            </Link>
          </div>
        </div>
