  ...
  return (
    ...
    >
      ...
      <Card>
        ...
        <BulletItem icon="📋">
          <strong>Underutilized §45b Benefit:</strong> €7.80B annual care relief budget sits unused; only 40% of eligible people utilize it
        </BulletItem>
        <BulletItem icon="⚠️">
