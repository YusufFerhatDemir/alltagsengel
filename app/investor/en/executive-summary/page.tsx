  ...
  return (
    ...
    >
      ...
      <Card>
        ...
        <BulletItem icon="📋">
          <strong>§45b Framework:</strong> €131/month care relief benefit serves 4.96M people, but only ~40% fully utilize it
        </BulletItem>
        <BulletItem icon="💰">
          <strong>Market Opportunity:</strong> €7.80B annual benefit pool, mostly fragmented and offline
        </BulletItem>
        <BulletItem icon="📱">
