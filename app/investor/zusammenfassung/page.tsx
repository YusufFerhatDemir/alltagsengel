...
import { DocPageLayout, Card, SectionTitle, Paragraph, BulletItem, StatBox, SectionLabel } from '../docs/shared'
  ...
  return (
    ...
    >
      ...
      <Card>
        ...
        <BulletItem><strong style={{color:'#C9963C'}}>§45b-Rahmen:</strong> €131/Monat pro Pflegebedürftiger – 4,96 Mio Menschen × €131 × 12 Monate = €7,80 Mrd/Jahr</BulletItem>
