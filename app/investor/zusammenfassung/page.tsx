  ...
  return (
    ...
    >
      ...
      <Card>
        ...
        <BulletItem><C>§45b-Rahmen:</C> €125/Monat pro Pflegebedürftiger – 4,96 Mio Menschen × €125 = €7,44 Mrd/Jahr</BulletItem>
        <BulletItem><C>Eingebauter Finanzierungsmechanismus:</C> Krankenkassen zahlen direkt – kein Zahlungsausfallrisiko</BulletItem>
        <BulletItem><C>Fragmentierter Markt:</C> Keine digitale Lösung dominiert – First-Mover-Vorteil</BulletItem>
        <BulletItem><C>AlltagsEngel digitalisiert diese Ineffizienz</C> – und schafft einen profitablen Zweiseitenmarkt</BulletItem>
      </Card>
