...
const cities: Record<string, CityData> = {
  ...
  maintal: {
    ...
    landmarks: ['Klinikum Hanau', 'Sana Klinikum Offenbach', 'Universitätsklinikum Frankfurt'],
    geo: { latitude: 50.1478, longitude: 8.8331 },
  ...
  'bad-vilbel': {
    ...
    landmarks: ['Universitätsklinikum Frankfurt', 'Bürgerhospital Frankfurt', 'Bürgerhospital Friedberg'],
    geo: { latitude: 50.1786, longitude: 8.7367 },
  ...
  'main-taunus': {
    ...
    landmarks: ['Main-Taunus-Kliniken Bad Soden', 'Klinikum Frankfurt Höchst', 'Helios Dr. Horst Schmidt Kliniken Wiesbaden'],
